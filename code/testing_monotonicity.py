...
capacities = [1,3,2]
travel_times = [1,0,0]
net_inflow = RightConstant([0,0.6,1.75,2],[2.5,1,3,0],(0,2))
...
i1 = RightConstant([0,0.3,0.6,2],[1.75,0.25,0,0],(0,2))
i2 = RightConstant([0,0.3,0.6,1.75,2],[0.75,2.25,1,3,0],(0,2))
...
i18 = RightConstant([0,0.6,2],[1,0,0],(0,2))
i19 = RightConstant([0,0.6,1.75,2],[1.5,1,3,0],(0,2))
