...
i1 = RightConstant([0,500],[0,0],(0,500))
i2 = RightConstant([0,500],[0,0],(0,500))
i3 = RightConstant([0,500],[0,0],(0,500))
i4 = RightConstant([0,100,200,300,400,500],[2,1,2,1,1.5,0],(0,500))
i5 = RightConstant([0,500],[0,0],(0,500))
i6 = RightConstant([0,500],[0,0],(0,500))
i7 = RightConstant([0,100,200,300,400,500],[1,2,1,2,1.5,0],(0,500))
i8 = RightConstant([0,500],[0,0],(0,500))
...
i18 = RightConstant([0,500],[0,0],(0,500))
i19 = RightConstant([0,500],[0,0],(0,500))
i20 = RightConstant([0,500],[0,0],(0,500))
i21 = RightConstant([0,500],[1.5,0],(0,500))
i22 = RightConstant([0,500],[0,0],(0,500))
i23 = RightConstant([0,500],[0,0],(0,500))
i24 = RightConstant([0,500],[1.5,0],(0,500))
i25 = RightConstant([0,500],[0,0],(0,500))
