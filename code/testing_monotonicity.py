...
graph.edges = [e1,e2,e3,e4,e5,e6,e7]

capacities = [1,3,1,3,2,2,2]
...
i3 = RightConstant([0,2],[0,0],(0,2))
i4 = RightConstant([0,2],[0,0],(0,2))
...
i9 = RightConstant([0,2],[0,0],(0,2))
i10 = RightConstant([0,2],[0,0],(0,2))
...
monotonicity_check(graph, capacities, travel_times, net_inflow,2,[p1,p2,p3,p4], in_f, in_g)