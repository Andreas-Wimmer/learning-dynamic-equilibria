...
capacities = [1,3,2]
travel_times = [1,0,0]
net_inflow = RightConstant([0,1,1.5,2],[3.5,4,4,0],(0,2))
...
i2 = RightConstant([0,0.5,1,1.5,2],[2,3,3,4,0],(0,2))
...
i18 = RightConstant([0,1,1.5,2],[1,2,0,0],(0,2))
i19 = RightConstant([0,1,1.5,2],[2.5,2,4,0],(0,2))
