...
graph.nodes = {0:s,1:v,2:x,3:y,4:t}
graph.edges = [e1,e2,e3,e4,e5,e6,]

capacities = [4,1,3,1,1,2]
travel_times = [1,1,1,1,1,1]
net_inflow = RightConstant([0,1,1.5,3],[3,1,3,0],(0,3))
...
i1 = RightConstant([0,0.5,1,3],[0.75,0.25,0,0],(0,3))
i2 = RightConstant([0,0.5,1,3],[0.75,0.25,0,0],(0,3))
...
i7 = RightConstant([0,1,3],[0.5,0,0],(0,3))
i8 = RightConstant([0,1,3],[0.5,0,0],(0,3))
...
monotonicity_check(graph, capacities, travel_times, net_inflow,3, [p1,p2,p3,p4], in_f, in_g)