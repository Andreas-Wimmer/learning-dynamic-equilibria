...
capacities = [1,3,2]
travel_times = [1,0,0]
net_inflow = RightConstant([0,0.4,1.75,2],[2.5,1,3,0],(0,2))
...
i1 = RightConstant([0,0.2,0.4,2],[1.5,0.5,0,0],(0,2))
i2 = RightConstant([0,0.2,0.4,1.75,2],[1,2,1,3,0],(0,2))
...
i18 = RightConstant([0,0.4,2],[1,0,0],(0,2))
i19 = RightConstant([0,0.4,1.75,2],[1.5,1,3,0],(0,2))
