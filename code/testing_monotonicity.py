...
e8 = Edge(x,w,7,graph)
e9 = Edge(v,w,8,graph)
e10 = Edge(v,z,9,graph)
e11 = Edge(w,y,10,graph)
e12 = Edge(w,t,11,graph)
e13 = Edge(w,z,12,graph)
e14 = Edge(y,t,13,graph)
e15 = Edge(z,t,14,graph)
...
i1 = RightConstant([0,1,1.75,4],[1.5,2,1,0],(0,4))
...
i7 = RightConstant([0,0.5,1,4],[1.5,0.5,0,0],(0,4))
...
i18 = RightConstant([0,1,1.75,4],[1.5,2,1,0],(0,4))
...
i24 = RightConstant([0,1,4],[1,0,0],(0,4))
...
in_f = [i1,i2,i3,i4,i5,i6,i7,i8,i9,i10,i11,i12,i13,i14,i15,i16,i17]
in_g = [i18,i19,i20,i21,i22,i23,i24,i25,i26,i27,i28,i29,i30,i31,i32,i33,i34]

paths = [p1,p2,p3,p4,p5,p6,p7,p8,p9,p10,p11,p12,p13,p14,p15,p16,p17]
