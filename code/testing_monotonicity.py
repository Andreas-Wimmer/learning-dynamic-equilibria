...
i1 = RightConstant([0,0.5,1,1.75,2],[1.1,0.9,0,0.9,0],(0,2))
i2 = RightConstant([0,0.5,1,1.75,2],[0.9,1.1,1,1.1,0],(0,2))
...
i7 = RightConstant([0,1,1.75,2],[1,0,0.9,0],(0,2))
i8 = RightConstant([0,1,1.75,2],[1,1,1.1,0],(0,2))
