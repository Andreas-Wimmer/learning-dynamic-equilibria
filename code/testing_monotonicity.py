...
i6 = RightConstant([0,0.5,1,4],[1,1,0,0],(0,4))
i7 = RightConstant([0,0.5,1,1.75,4],[0.5,0.5,3,1,0],(0,4))
...
i23 = RightConstant([0,1,4],[1,0,0],(0,4))
i24 = RightConstant([0,1,1.75,4],[0.5,3,1,0],(0,4))
