...
graph.nodes = {0:s,1:u,2:v,3:w,4:x,5:t}
graph.edges = [e1,e2,e3,e4,e5,e6,e7,e8,e9,e10]

capacities = [2,3,1,2,1,1,3,1,2,2]
...
i1 = RightConstant([0,0.5,1,5],[1,1,1,0],(0,5))
i2 = RightConstant([0,5],[0,0],(0,5))
i3 = RightConstant([0,0.5,1,5],[1.5,0.5,0,0],(0,5))
i4 = RightConstant([0,5],[0,0],(0,5))
i5 = RightConstant([0,5],[0,0],(0,5))
i6 = RightConstant([0,5],[0,0],(0,5))
i7 = RightConstant([0,0.5,1,1.75,5],[0.5,0.5,2,0,0],(0,5))
i8 = RightConstant([0,5],[0,0],(0,5))
i9 = RightConstant([0,0.5,1,1.75,5],[1,2,1,3,0],(0,5))
...
i18 = RightConstant([0,1,5],[1,1,0],(0,5))
i19 = RightConstant([0,5],[0,0],(0,5))
i20 = RightConstant([0,1,5],[1,0,0],(0,5))
i21 = RightConstant([0,5],[0,0],(0,5))
i22 = RightConstant([0,5],[0,0],(0,5))
i23 = RightConstant([0,5],[0,0],(0,5))
i24 = RightConstant([0,1,1.75,5],[0.5,2,0,0],(0,5))
i25 = RightConstant([0,5],[0,0],(0,5))
i26 = RightConstant([0,1,1.75,5],[1.5,1,3,0],(0,5))
...
monotonicity_check(graph, capacities, travel_times, net_inflow,5,paths, in_f, in_g)