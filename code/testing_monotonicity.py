...
capacities = [1,3,2]
travel_times = [1,0,0]
net_inflow = RightConstant([0,1,1.5,2],[1.25,1.25,3,0],(0,2))
...
i1 = RightConstant([0,0.5,1,2],[1.25,0.75,0,0],(0,2))
i2 = RightConstant([0,0.5,1,1.5,2],[0,0.5,1.25,3,0],(0,2))
...
i19 = RightConstant([0,1,1.5,2],[0.25,1.25,3,0],(0,2))
