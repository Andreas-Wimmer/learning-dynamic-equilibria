...
i1 = RightConstant([0,0.5,1,1.75,2],[1.05,0.95,0,0.95,0],(0,2))
i2 = RightConstant([0,0.5,1,1.75,2],[0.95,1.05,1,1.05,0],(0,2))
...
i7 = RightConstant([0,1,1.75,2],[1,0,0.95,0],(0,2))
i8 = RightConstant([0,1,1.75,2],[1,1,1.05,0],(0,2))
