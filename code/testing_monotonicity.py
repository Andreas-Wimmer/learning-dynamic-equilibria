...
capacities = [1,3,2]
travel_times = [1,0,0]
net_inflow = RightConstant([0,1,1.5,2],[1.1,1.1,3,0],(0,2))
...
i1 = RightConstant([0,0.5,1,2],[1.1,0.9,0,0],(0,2))
i2 = RightConstant([0,0.5,1,1.5,2],[0,0.2,1.1,3,0],(0,2))
...
i19 = RightConstant([0,1,1.5,2],[0.1,1.1,3,0],(0,2))
