...
net_inflow = RightConstant([0,3],[2.5,0],(0, 3))

path_1 = [edge_1, edge_4]
path_2 = [edge_2, edge_4]
path_3 = [edge_3, edge_4]

inflow_1 = RightConstant([0,0.5,1],[1.25,0.75,0],(0,3))
inflow_2 = RightConstant([0,1,1.5,2],[0,1.25,0.75,0],(0,3))
inflow_3 = RightConstant([0,0.5,1,1.5,2,3],[1.25,1.75,1.25,1.75,2.5,0],(0,3))
